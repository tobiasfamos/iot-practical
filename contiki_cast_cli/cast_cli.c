...
/* EXERCISE 4 PROCESS (TO BE STARTED WITH AUTOSTART_PROCESS */

PROCESS(exercise_4_process, "Exercise 4 - Using Shell Commands");
PROCESS_THREAD(exercise_4_process, ev, data)
{
  PROCESS_BEGIN();
  serial_shell_init();
...
AUTOSTART_PROCESSES(&exercise_4_process);



/*  Question 1: Revisiting the Broadcast and Unicast with command line shell interface
 *
 ...
 *  this program, using your knowledge from previous exercises.
 *
 */
